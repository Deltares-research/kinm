...
def location(
    fc, fskey, name, x, y, epsg, shortname="", description="", z=0, altitude_msl=0
):
    """
    Parameters
    ----------
...
def sparameter(
    ...
    parametergroup : string, optional
        This could be usefull incase aggregations are necessary (like all Phosphate aggregations). The default is None.
